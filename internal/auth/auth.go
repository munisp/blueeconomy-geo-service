...
// blueeconomy-ferry-ticketing / maritime-intelligence pattern and fails
// closed on every ambiguity. The principal carries the geo clearance ladder
// (PUBLIC..SECRET) for row-level clearance enforcement and the tenant
// binding for RLS.
package auth
...
// validatedClearance maps an asserted clearance to the geo ladder. An absent
// clearance defaults to PUBLIC (the least-restrictive label, matching the
// maritime-intelligence doctrine of defaulting absent clearance to the floor);
